<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddProduct.aspx.cs" Inherits="UTTT.Ejemplo.Persona.products.AddProduct" %>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id="formSignup" runat="server">
                    ...
                    <div class="form-group">
                        <label>Stock</label>
                        <asp:TextBox ID="inStock" TextMode="Number" runat="server" CssClass="form-control"></asp:TextBox>
                    </div>
                    <hr />
