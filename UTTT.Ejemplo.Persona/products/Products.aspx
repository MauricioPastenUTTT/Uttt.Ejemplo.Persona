<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Products.aspx.cs" Inherits="UTTT.Ejemplo.Persona.products.Products" %>
...
<body>
    <form id="form1" runat="server" class="container mt-4">
         <div class="table-responsive">
            <asp:GridView ID="GridViewProducts" DataKeyNames="id" runat="server" AutoGenerateColumns="False" DataSourceID="LinqDcUsers" OnRowCommand="GridViewProducts_RowCommand"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="inStock" HeaderText="inStock" ReadOnly="True" SortExpression="inStock" />
        ...
        <div class="mt-2">
            ...
            <asp:Button ID="btnAddProduct" Text="Add" CssClass="btn btn-secondary" OnClick="btnAddProduct_Click" runat="server" />
        </div>
    </form>
